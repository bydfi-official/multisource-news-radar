...
```text
Use Multisource News Radar to find the strongest public signals for:
<topic>
...
```text
Use Multisource News Radar with no query to run the default global-hot profile.
...
```text
Use Multisource News Radar in reputation mode for:
...
```text
Use Multisource News Radar in research mode for:
...
```text
Use Multisource News Radar with these feeds:
<feed URLs>
...
```text
Use Multisource News Radar for this login-gated page:
<URL>
...
```text
Set up Multisource News Radar as a recurring briefing.
