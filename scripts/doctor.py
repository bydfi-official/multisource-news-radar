#!/usr/bin/env python3
"""Environment doctor for Multisource News Radar."""
...
def markdown(checks: list[Check], repair_plan: bool) -> str:
    lines = ["# Multisource News Radar Doctor", "", "| Check | Status | Detail |", "| --- | --- | --- |"]
    for check in checks:
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Check Multisource News Radar dependencies.")
